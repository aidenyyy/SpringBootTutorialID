...
public class SurveyController {
	...
	@GetMapping("/form")
	public String survey(SurveyForm surveyForm,
			Model model,
	...
	@PostMapping("/form")
	public String returnSurvey(SurveyForm surveyForm, Model model) {
	...
	public String confirm(@Validated SurveyForm surveyForm,
		...
		model.addAttribute("title", "Please Confirm Your Entries.");
